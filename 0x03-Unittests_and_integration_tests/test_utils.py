...
class TestAccessNestedMap(unittest.TestCase):
    ...
    def test_access_nested_map(
        ...
        """It should return expected result for valid paths."""
...
class TestGetJson(unittest.TestCase):
    ...
    def test_get_json(self, test_url: str,
                      ...
                      mock_get: Mock) -> None:
        """get_json must return the expected JSON without real HTTP call."""
...
class TestMemoize(unittest.TestCase):
    ...
    def test_memoize(self) -> None:
        """a_method should be called only once despite two property calls."""
        class TestClass:
